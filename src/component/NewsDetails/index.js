              ...
              <div className="news_detail_wrapper">
                <div className="news_details_content_area">
                  ...
                  <p>
                    ...
                    isnt anything embarrang hidden in the middle of text. All the Lorem Ipsum
                  ...
                  <p>
                    ...
                    alteration in some injected or words which dont look even slightly believable.
                  </p>
                  <ul>
                    <li>
                      <i className="fas fa-circle"></i> Lorem ipsum dolor sit amet, cibo mundi ea
                      duo, vim exerci phaedrum.
                    </li>
                    <li>
                      <i className="fas fa-circle"></i> There are many variations of passages of
                      Lorem Ipsum.
                    </li>
                    <li>
                      <i className="fas fa-circle"></i> Available but the majority have alteration
                      in some injected or words.
                    </li>
                    <li>
                      <i className="fas fa-circle"></i> There are many variations of passages of
                      Lorem Ipsum which dont look even slightly believable.
                    </li>
                  </ul>
                  <div className="row">
